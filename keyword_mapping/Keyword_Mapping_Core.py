...
class KeywordMappingCore:
    def __init__(self,cbs_dict,cpl_dict,ccf_dict,notes_ref_dict,notes_region_meta_data,standardised_cropped_dict,standard_note_meta_dict,transformed_standardised_cropped_dict) -> None:
