...
class Keyword_mapping_Settings(BaseSettings):
    ...
    mastersheet_filter_particulars : str = os.path.join(path.dirname(__file__),'../assets/keywords_library/mastersheet_filter_particulars.tsv')
    mastersheet_total_particulars : str = os.path.join(path.dirname(__file__),'../assets/keywords_library/mastersheet_total_particulars.tsv')
